...
/*
 * This section is the recursive descent parser of C expressions. heir1()
 * thru heir15() implement the hierarchy of operators.
 */
...
/* See if next token is a structure member */
ismember(op)
    struct operand *op;
{
    char	    name   [NAMESIZE];
