...
int tbitset = 0;  /* size of lookahead sets */
struct looksets lkst [ LSETSIZE ] = 0;
int nlset = 0; /* next lookahead set index */
int nolook = 0; /* flag to suppress lookahead computations */
struct looksets clset = 0;  /* temporary storage for lookahead computations */

	/* working set computations */

struct wset wsets[ WSETSIZE ] = 0;
struct wset *cwp = 0;

	/* state information */

int nstate = 0;		/* number of states */
struct item *pstate[NSTATES+2] = 0;	/* pointers to the descriptions of the states */
int tystate[NSTATES] = 0;	/* contains type information about the states */
int indgo[NSTATES] = 0;		/* index to the stored goto table */
int tstates[ NTERMS ] = 0; /* states generated by terminal gotos */
int ntstates[ NNONTERM ] = 0; /* states generated by nonterminal gotos */
int mstates[ NSTATES ] = 0; /* chain of overflows of term/nonterm generation lists  */

	/* storage for the actions in the parser */

short amem[ACTSIZE] = 0;	/* action table storage */
int *memp = amem;	/* next free action table position */

	/* other storage areas */

int temp1[TEMPSIZE] = 0; /* temporary storage, indexed by terms + ntokens or states */
...
int **pres[NNONTERM+2] = 0;  /* vector of pointers to productions yielding each nonterminal */
struct looksets *pfirst[NNONTERM+2] = 0;  /* vector of pointers to first sets for each nonterminal */
int pempty[NNONTERM+1] = 0;  /* vector of nonterminals nontrivially deriving e */
