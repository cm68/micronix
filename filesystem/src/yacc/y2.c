...
int numbval = 0;	/* value of an input number */
char tokname[NAMESIZE] = 0;	/* input token name */

	/* storage of names */

char cnames[CNAMSZ] = 0;	/* place where token and nonterminal names are stored */
...
int ndefout = 3;  /* number of defined symbols output */
	...
	/* storage of types */
int ntypes = 0;	/* number of types defined */
char * typeset[NTYPES] = 0;	/* pointers to type tags */

	/* symbol tables for tokens and nonterminals */

int ntokens = 0;
struct toksymb tokset[NTERMS] = 0;
int toklev[NTERMS] = 0;
int nnonter = -1;
struct ntsymb nontrst[NNONTERM] = 0;
int start = 0;	/* start symbol */
...
FILE * finput = 0;		/* yacc input file */
FILE * faction = 0;		/* file for saving actions */
FILE * fdefine = 0;		/* file for # defines */
FILE * ftable = 0;		/* y.tab.c file */
FILE * ftemp = 0;		/* tempfile to pass 2 */
FILE * foutput = 0;		/* y.output file */

	/* storage for grammar rules */

int mem0[MEMSIZE] = 0 ; /* production storage */
int *mem = mem0;
int nprod= 1;	/* number of productions */
int *prdptr[NPROD] = 0;	/* pointers to descriptions of productions */
int levprd[NPROD] = 0 ;	/* precedence levels for the productions */
