 ...
 *
 * hitech.h
 * Changed: <2023-07-04 10:50:20 curt>
 *
 ...
 * types, and so on.
 * 
 * new information has come to light, ins and outs and whathaveyous.
 * specifically, the object file format is now documented
 *
 * XXX - this file needs to be updated based on all of this new shit, man.
 * see src/tools/objdump.c
 */
