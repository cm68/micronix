...
/*
 * Was END_OPTION_STRING - seventeen characters, and the compiler
 * keeps sixteen.
 */
#define	END_OPTSTRING	('$')
 ...
 * the first call declares it extern int and the static definition
 * then disagrees.
 */
static int getnum();
...
/*
 * Scan to end of string or to an END_OPTSTRING character.
