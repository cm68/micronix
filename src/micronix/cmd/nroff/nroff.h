 ...
 */
#define	TMACFULL	"/usr/lib/tmcs/tmac."
#define	TMACPRE		"/tmac."
...
#define MACBUF		100000	/* macro definition buffer size (32000) */
#define MXMLEN		2000	/* max length of each macro definition (250) */
...
char			tmpdir[256];
char			termcap[1030];
char			s_standout[20];		/* standout */
char			e_standout[20];
char			s_bold[20];		/* \fB bold */
char			e_bold[20];
char			s_italic[20];		/* \fI italic */
char			e_italic[20];
char			s_special[20];		/* \fS special */
char			e_special[20];
char			s_small[20];		/* small */
char			e_small[20];
char			e_all[20];		/* \fR normal */
...
extern char		s_special[];
extern char		e_special[];
extern char		s_small[];
extern char		e_small[];
extern char		e_all[];
extern char	       *dbgfile;
