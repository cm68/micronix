...
NCMDS	equ	12		;number of legal commands
...
4:
	...
	jr	1b
3:
	ld	bc,cmdstart	; bc - stack - cmdstart
	ld	hl,stack
	or	a
	sbc	hl,bc
	ld	b,h
...
1:
	push	de		;save ptr
	ld	c,SDMA
	call	ENTRY		;set buffer address
	ld	de,DFCB
	ld	c,READ
	call	ENTRY		;read sector
	pop	hl		;pop ptr
	ld	de,SECSIZE
	add	hl,de
	ex	de,hl
...
notfnd:
	defb	40
	defb	": Not found - change disks, hit a key"
	defb	7,0Dh,0Ah
nofile:
	defb	7
	defb	"No file"
