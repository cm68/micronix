...
void
activate_8259(byte port)
{
    register_input(port, &rd_pic_port_0);
    register_input(port + 1, &rd_pic_port_1);
    register_output(port, &wr_pic_port_0);
    register_output(port + 1, &wr_pic_port_1);
}
